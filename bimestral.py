...
print("El total de billetes de  diez mil en el dia fue de " + str(total_billetes_de_10000))
print("El total de billetes de  dos mil en el dia fue de " + str(total_billetes_de_2000))
print("El total de monedas de cien en el dia fue de " + str(total_monedas_de_100))
